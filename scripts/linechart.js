...
function readTextFileLineChart(file) {
...
readTextFileLineChart("scripts/lungime_tweet.json");
...
var data = {
    "cols": [" less than 40 ", " between 41 and 80 ", " between 81 and 110 ", " more than 110 "],
    "data": [{ "name": "letters", "values": [counterLineChart[0], counterLineChart[1], counterLineChart[2], counterLineChart[3]] }]
};
